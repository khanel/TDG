...
class EffectivenessFirstReward:
    ...
    def calculate(
        ...
        improvement = int(state.get('improvement_binary', 0))
...
class RewardWrapper:
    ...
    def compute(
        ...
        [2] improvement_binary: float {0,1} - did we improve this step?
        ...
        improvement = int(obs[2])  # Already binary from environment
...
def compute_reward(
    ...
    Args:
        ...
        improvement: Whether improvement occurred this step (0 or 1)
