...
from temp.core.reward import HybridSearchReward
...
def run_validation():
    ...
    reward_computer = HybridSearchReward()
...
def run_gradient_analysis(reward_computer):
    ...
    for stag in np.linspace(0, 1, 100):
        ...
        signal = reward_computer.calculate(inputs, 0, context) # Action: Continue
        val = signal.total_value
    ...
    for _ in range(1000):
        ...
        # Get rewards
        r1 = reward_computer.calculate(base_state, 0, context).total_value
        r2 = reward_computer.calculate(perturbed_state, 0, context).total_value
