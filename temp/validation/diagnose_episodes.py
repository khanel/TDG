...
from temp.core.intelligent_reward import IntelligentSearchReward
...
class TracingOrchestratorEnv(OrchestratorEnv):
    ...
    def __init__(self, n_items: int = 100, k_interactions: int = 5, 
        ...
        explorer = GrayWolfOptimization(problem, population_size=population_size)
        exploiter = GeneticAlgorithm(problem, population_size=population_size)
        ...
        self.reward_comp = IntelligentSearchReward()
    ...
    def step(self, action: int):
        ...
        budget_remaining, current_fitness, stagnation, diversity, active_phase = obs
        ...
        improvement = 1 if current_fitness < self.previous_best_fitness else 0
        ...
        state_vector = {
            ...
            'fitness_norm': current_fitness
        }
        context = {'current_phase': phase_name}
        
        # Calculate reward
        reward_signal = self.reward_comp.calculate(state_vector, action, context)
        reward = reward_signal.total_value
        ...
        self.trace.append({
            ...
            'obs': {
                ...
                'norm_fitness': float(current_fitness),
            ...
            'reward': float(reward),
            'reward_components': reward_signal.raw_components,
