#!/usr/bin/env python3
"""
Episode Simulation Validator for Effectiveness-First Reward (EFR)
==================================================================
...
Version: 2.0.0 - Updated for EFR reward function
"""
...
from RLOrchestrator.core.reward import RewardWrapper, EFRConfig, RewardSignal
...
class EpisodeSimulator:
    """
    Simulates complete episodes with the EFR reward function.
    """
    
    def __init__(self, config: Optional[EFRConfig] = None, max_steps: int = 100):
        self.reward_fn = RewardWrapper(config or EFRConfig())
    ...
    def simulate_step(
        ...
        info = {'current_phase': phase.value}
        return self.reward_fn.compute(obs, action, info)
