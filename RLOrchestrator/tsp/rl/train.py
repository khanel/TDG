...
def build_parser() -> argparse.ArgumentParser:
    ...
    g_train.add_argument("--exploration-population", type=int, default=32)
    g_train.add_argument("--exploitation-population", type=int, default=8)
    ...
    add_model_io_args(g_io, model_output_default="ppo_tsp")

    g_problem.add_argument("--tsp-num-cities", type=str, default="20")
    g_problem.add_argument("--tsp-grid-size", type=float, default=100.0)
    g_problem.add_argument("--tsp-seed", type=int, default=42)
    g_problem.add_argument("--tsp-coords-file", type=str, default=None)
    g_problem.add_argument("--tsp-distance-file", type=str, default=None)
    return parser
...
def main():
    ...
    logger = setup_logging('train', 'tsp', log_dir=str(artifacts.logs_dir), session_id=session_id)
